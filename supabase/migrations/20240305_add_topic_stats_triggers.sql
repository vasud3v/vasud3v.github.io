-- ============================================================================
-- Add Topic Stats Auto-Update Triggers
-- ============================================================================
-- This migration creates triggers to automatically update topic statistics
-- (thread_count, post_count, last_activity) when threads and posts change.

-- ============================================================================
-- Function: Update topic stats when thread is created/deleted/moved
-- ============================================================================
